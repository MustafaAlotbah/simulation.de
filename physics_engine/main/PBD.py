...
from physics_engine.simulation import Simulation, Particle, Spring, PositionConstraint, INTEGRATOR_LEAPFROG, INTEGRATOR_RK4, INTEGRATOR_RK2
...
if __name__ == "__main__":
    ...
    for i in range(num_joints):
        ...
        sim.position_constraints.append(PositionConstraint(sim.particles[-2], sim.particles[-1]))
